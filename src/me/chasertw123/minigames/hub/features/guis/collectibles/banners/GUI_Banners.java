package me.chasertw123.minigames.hub.features.guis.collectibles.banners;
...
public class GUI_Banners extends AbstractGui {
    ...
    public GUI_Banners(User user) {
        super(6, "Banners", user.getCoreUser());
